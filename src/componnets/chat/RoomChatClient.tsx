...
const RoomChatClient = ({ room }: RoomChatClientProps) => {
  ...
  return (
    <main className="min-h-screen w-full theme-page p-4 sm:p-6">
      {auth.isLoggedIn ? (
        <div className="relative mx-auto flex h-auto min-h-[60vh] w-full max-w-none flex-col rounded-2xl border theme-panel p-4 shadow backdrop-blur md:h-[calc(100vh-3rem)]">
