...
const RoomChatClient = ({ room }: RoomChatClientProps) => {
  ...
  return (
    <main className="h-[90vh] w-full overflow-hidden theme-page p-2">
      {auth.isLoggedIn ? (
        <div className="mx-auto grid h-full w-full max-w-6xl grid-cols-1 gap-0 lg:grid-cols-[minmax(0,1fr)_280px]">
          <section className="relative flex h-full min-h-0 flex-1 flex-col border theme-panel p-3 shadow backdrop-blur">
